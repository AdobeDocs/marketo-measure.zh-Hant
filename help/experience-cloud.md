---
description: 適用於Marketo Measure使用者的Adobe Experience Cloud介面概觀指南
...
![如果您已登入Adobe Experience Cloud產品，](assets/unified-overview-6.png)
...
[管理您的 [!DNL Marketo Measure] 網域](/help/domain-management.md)，不需要[!DNL Marketo Measure]的協助。

![無需Marketo Measure的協助即可管理您的Marketo Measure網域(/help/domain-management.md)。](assets/unified-overview-9.png)

**整合式說明中心**

搜尋支援文章、提交票證、提供意見回饋，所有這些都是從[!DNL Marketo Measure]應用程式中進行。

![搜尋支援文章、提交票證、提供意見回饋，全部來自](assets/unified-overview-5.png)

**應用程式切換器**

能夠存取多個Adobe產品的使用者可在兩者之間輕鬆切換。

![可以存取多個Adobe產品的使用者可以輕鬆切換](assets/unified-overview-4.png)

**通知和公告**

直接在應用程式中檢視產品特定通知和一般 Adobe 產品公告，並進行互動。

![直接檢視與產品特定通知和一般Adobe產品公告並互動](assets/unified-overview-10.png)

![直接檢視與產品特定通知和一般Adobe產品公告並互動](assets/unified-overview-11.png)

**Adobe 設定**

若要變更您的語言或其他Adobe偏好設定，請按一下您的個人資料圖示。 您也可以按一下&#x200B;**我的設定**，進行[!DNL Marketo Measure]特定的變更。

![若要變更您的語言或其他Adobe範圍喜好設定，請按一下您的設定檔圖示。](assets/unified-overview-8.png)
...
![如果您可以登入Adobe Experience Cloud，但看見](assets/unified-overview-7.png)
