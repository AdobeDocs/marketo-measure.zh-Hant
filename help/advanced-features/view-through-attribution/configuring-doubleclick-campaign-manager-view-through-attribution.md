...
如需有關透過歸因功能檢視[!DNL Marketo Measure]的詳細資訊，請參閱[透過歸因常見問答集](/help/advanced-features/view-through-attribution/marketo-measure-view-through-attribution-faq.md)Marketo Measure檢視。
