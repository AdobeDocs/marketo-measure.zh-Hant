...
![顯示MQL和SQL boomerang接觸點的潛在客戶歷程圖，其進度依時間順序列至商機](assets/1-1.png)

**案例2：潛在客戶的Boomerang接觸點和自訂階段**

在此案例中，客戶已選擇只追蹤&#x200B;**SQL階段**&#x200B;與迴旋式接觸點。 仍在追蹤MQL和SAL階段，但使用[!DNL Marketo Measure]自訂階段功能。

![顯示將MQL和SAL追蹤為自訂階段的SQL boomerang接觸點的潛在客戶歷程](assets/2-1.png)
...
![潛在客戶歷程顯示已略過的SAL階段，其中SAL和OC位置合並於相同接觸點](assets/3.png)
...
![顯示MQL和SAL boomerang接觸點轉譯為Opportunity的三個潛在客戶歷程圖](assets/4.png)
...
![在Opportunity上顯示位置編號的MQL、SQL和SAL boomerang接觸點的三個潛在客戶歷程](assets/5.png)
...
![三個潛在客戶歷程，顯示在SQL階段之後發生時，從Opportunity排除的Web造訪回溯點接觸點](assets/6.png)
...
![顯示具有多階段轉換的回溯點歸因加權的三個潛在客戶歷程](assets/7.png)
...
![在商機上的OC接觸點之後顯示示範和交涉的Boomerang接觸點的連絡歷程](assets/8.png)
