---
description: Marketo Measure使用者最新版本注意事項指南
title: 最新發行說明
...
![您現在可以使用行銷活動和行銷活動成員欄位建立區段](assets/release-notes-2.png)
...
* 新檔案： [處理CRM匯出的設定時發生錯誤](/help/configuration-and-setup/crm-error-handling.md)
...
我們很高興介紹全新的[已歸因的機會儀表板](/help/attributed-opportunity-dashboard.md){target="_blank"}，其設計可讓您全面瞭解您的行銷工作如何對新興和成熟的管道機會作出貢獻。 此儀表板可讓您深入瞭解歸因於您策略的每個開啟和關閉商機的詳細資訊，並靈活地按商機階段篩選。 它提供哪些管道、子管道或行銷活動在歸因商機金額方面排名最高的深入分析，並顯示歸因商機金額總計以及歸因的未完成與已結束商機計數。

**適用於Marketo Measure Ultimate的Marketo Engage Cookie同步**
...
* [回溯階段與接觸點](/help/channel-tracking-and-setup/boomerang-stages-and-touchpoints.md){target="_blank"}
* [正在設定迴旋移動階段](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md){target="_blank"}
* [Boomerang階段案例](/help/channel-tracking-and-setup/boomerang-stage-scenarios.md){target="_blank"}
...
為協助您適應這項變更，[我們已建立檔案](/help/configuration-and-setup/error-notifications.md){target="_blank"}，其中包含明確的錯誤說明和完整的疑難排解步驟。
