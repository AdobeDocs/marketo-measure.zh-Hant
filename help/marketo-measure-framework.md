...
>[!NOTE]
>如需如何新增Marketo Measure JS的說明，[請按一下這裡](/help/marketo-measure-tracking/adding-marketo-measure-script.md)。
...
![Marketo Measure與CRM整合，以存放及組織所有資料](assets/overview-resources-14.png)
...
![大多數行銷人員依賴一些不同的應用程式來執行其行銷](assets/overview-resources-15.png)
