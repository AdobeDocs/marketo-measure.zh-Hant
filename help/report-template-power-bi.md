...
您可以在[!DNL Data Warehouse]資訊頁上的[!DNL Marketo Measure] UI中找到您特定的伺服器、倉儲和結構描述資訊。 有關如何找到此頁面的說明，請參閱[這裡](/help/data-warehouse-access-reader-account.md){target="_blank"}。
...
[![按一下下方影像以取得完整大小版本。](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
