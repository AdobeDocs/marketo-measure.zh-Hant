---
description: 使用「銷售機會速度」儀表板來測量每個funnel階段中的時間，並比較一段時間內每個管道的進度
title: 銷售機會速度控制面板
feature: Reporting
...
![在「首次接觸」階段所花的時間與](assets/lead-dashboard-1.png)相比如何
...
![潛在客戶/聯絡人在哪一個月是銷售中最快的進度](assets/lead-dashboard-2.png)
...
![「MQL」階段中的潛在客戶速度在不同的](assets/lead-dashboard-3.png)之間有何差異
