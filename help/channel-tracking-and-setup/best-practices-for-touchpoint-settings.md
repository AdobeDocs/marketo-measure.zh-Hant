---
description: Marketo Measure使用者接觸點設定指南的最佳作法
title: 接觸點設定的最佳實務
...
>[!MORELIKETHIS]
>
>* [接觸點移除與隱藏概述](/help/channel-tracking-and-setup/touchpoint-removal-and-touchpoint-suppression.md)
>* [絕不應該刪除接觸點的原因](/help/channel-tracking-and-setup/why-you-should-never-delete-touchpoints.md)
>* [購買者接觸點(BT)與購買者歸因接觸點(BAT)](/help/configuration-and-setup/difference-between-buyer-touchpoints-and-buyer-attribution-touchpoints.md)
