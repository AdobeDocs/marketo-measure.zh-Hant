...
![第一步是從](assets/online-channels-1.png)下載自訂管道試算表

試算表有七欄：

![試算表有七欄：](assets/online-channels-2.png)
...
第八欄會記下您無法從試算表刪除的規則為「請勿移除」。 試算表頂端有預設的管道規則，即使您未使用這些管道，[!DNL Marketo Measure]也建議不要變更或移除這些規則。[!DNL Marketo Measure] 與這些平台深度整合，預設情況下會包含這些平台。
...
![這些列代表規則和Marketo Measure](assets/online-channels-3.png)的順序
...
![Marketo Measure隨附12個預設管道供您使用。 這些](assets/online-channels-4.png)
...
![規則的每個引數或元件分別對應至](assets/online-channels-5.png)
...
![預設管道「其他」存在，以捕捉不符合](assets/online-channels-6.jpg)的資料
