...
>[!NOTE]
>
>[如何設定Boomerang階段的相關說明](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md)。
...
![若沒有Boomerang階段（「之前」），您只會看到最近的MQL](assets/boomerang-stages-18.png)
...
![使用下列範例，此Marketo Measure帳戶包含MQL](assets/boomerang-stages-19.png)
