---
description: Marketo Measure使用者離線管道指引的最佳作法
title: 離線管道的最佳作法
...
>[!MORELIKETHIS]
> [離線頻道設定](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
> [自訂Campaign同步 — 應用程式同步](/help/channel-tracking-and-setup/custom-campaign-sync.md)
> [正在同步處理離線行銷活動 — CRM同步](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
> [離線Campaign與Campaign成員 — CRM同步](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
> [Campaign同步日期 — CRM同步](/help/channel-tracking-and-setup/campaign-sync-dates.md)
> [多個行銷活動記錄型別的設定](/help/channel-tracking-and-setup/configurations-record-types.md)
> [建立行銷活動清單檢視](/help/channel-tracking-and-setup/creating-a-campaign-list-view-for-salesforce-campaigns.md)
> [正在同步處理歷史資料](/help/channel-tracking-and-setup/syncing-historical-data.md)
