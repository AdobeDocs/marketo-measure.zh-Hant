---
description: Marketo Measure使用者的A/B測試設定與報告指南
title: A/B測試設定與報告
...
1. 編輯銷售機會頁面配置，並將&#x200B;**[!DNL Marketo Measure]A/B測試**&#x200B;相關清單新增至頁面。
   ...
   ![1. 編輯銷售機會頁面配置並新增Marketo Measure](assets/advanced-features-2.png)
...
1. 按一下[!UICONTROL Wrench]按鈕。 從所選欄位清單中移除庫存「Id」欄位。 新增&#x200B;**[!UICONTROL Experiment]**、**[!UICONTROL Variation]**&#x200B;和&#x200B;**[!UICONTROL DateReported]**&#x200B;欄位。 將「[!UICONTROL Sort by]」變更為&#x200B;**[!UICONTROL Date Reported]**，然後在下拉式清單中選取&#x200B;**[!UICONTROL Descending]**。
   ...
   ![1. 按一下扳手按鈕。 從](assets/advanced-features-3.png)移除庫存「ID」欄位

1. 在[!UICONTROL Buttons]底下，取消核取&#x200B;**[!UICONTROL New]**。

   ![1. 在[按鈕]下，取消核取[新增]。](assets/advanced-features-7.png)
...
![具有商機的Marketo Measure A/BTests](assets/advanced-features-8.png)
...
以下是報告A/B測試時建議使用的一些欄位，有助於提高清晰度和insight：
...
![含潛在客戶的Marketo Measure A/B測試](assets/advanced-features-9.png)

**[!DNL Marketo Measure]個A/B測試與機會**

![具有商機的Marketo Measure A/B測試](assets/advanced-features-10.png)
