---
description: Marketo Measure使用者的Salesforce活動歸因指引
...
![Marketo Measure Salesforce活動整合帶來了特定任務和](assets/activities-attribution-10.png)
...
![如果您想要為每個銷售代表設定唯一的行銷活動](assets/activities-attribution-11.png)
...
![規則作為篩選器來告知我們哪些記錄是](assets/activities-attribution-12.png)
...
![安裝套件時，Marketo Measure包含自訂Buyer Touchpoint](assets/activities-attribution-13.png)

別忘了為任務或事件設定不同的規則。 您必須知道您的銷售團隊使用哪個物件來記錄其活動。

![別忘了為任務或事件設定不同的規則。 您](assets/activities-attribution-5.png)
...
![| 符合任何（包含） | 多個值 — &amp;42；值&amp;42；，&amp;42；值，&amp;42；值&amp;42； |](assets/activities-attribution-8.png)
...
![最後但並非最不重要的是，您可以選擇輸入成本](assets/activities-attribution-9.png)
