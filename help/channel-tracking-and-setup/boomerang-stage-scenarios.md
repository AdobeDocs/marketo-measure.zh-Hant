---
description: Marketo Measure使用者的Boomerang階段案例指南
title: 迴旋舞步舞台情境
...
![此案例使用的條件與案例2相同。 客戶有](assets/boomerang-stages-20.png)
...
![在此案例中，客戶已選擇追蹤MQL和](assets/boomerang-stages-21.png)
...
![來自Lead 1的所有接觸點都包含在Opportunity中，來自](assets/boomerang-stages-22.png)
...
![在此案例中，客戶已選擇追蹤MQL、SQL、](assets/boomerang-stages-23.png)
...
![在此案例中，客戶已選擇追蹤MQL、SQL、](assets/boomerang-stages-25.png)
...
![在此案例中，客戶已選擇追蹤示範和](assets/boomerang-stages-25.png)
