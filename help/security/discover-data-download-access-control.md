---
description: '[!UICONTROL Discover Data Download]存取控制'
...
1. 按一下&#x200B;**[!UICONTROL Data Access]**&#x200B;下的[!UICONTROL Security]。
   ...
   ![安全性設定頁面中反白顯示資料存取選項](assets/discover-data-download-access-control-1.png)

1. 按一下下拉式清單，然後為您的主控台選取適當的選項。

   ![資料下載存取下拉式清單，顯示「所有使用者」、「僅限管理員使用者」和「無」](assets/discover-data-download-access-control-2.png)
...
1. 完成時，按一下&#x200B;**[!UICONTROL Save]**。
   ...
   ![探索資料下載原則已儲存的確認](assets/discover-data-download-access-control-3.png)
