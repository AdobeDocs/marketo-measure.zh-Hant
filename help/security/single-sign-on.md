...
![具有自訂SSO登入型別選項的驗證設定頁面](assets/single-sign-on-1.png)
...
具有使用者屬性對應欄位的![SAML設定表單](assets/single-sign-on-2.png)
...
![使用者角色對應組態包含標準使用者和管理員選項](assets/single-sign-on-3.png)
...
![成功的SSO登入確認畫面](assets/single-sign-on-6.png)
