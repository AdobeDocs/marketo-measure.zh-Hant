...
使用包含AJAX （或其他機制）的表單將轉換日期從使用者端提交至我們的伺服器時，[!DNL Marketo Measure]可能不知道客戶透過我們監控的任何標準路徑的轉換。 在這個案例中，我們可以使用簡單的API （如下所示）。
...
## 案例2 — 以非HTML表單收集的銷售機會資訊 {#scenario-lead-information-collected-in-a-non-html-form}
