---
description: 適用於Marketo Measure使用者的 [!DNL Marketo Measure] Web工作階段指導的定義
...
假設Haley在LinkedIn上，按一下[!DNL Marketo Measure]張貼並重新導向至Adobe網站。 接著，在捲動[!DNL Facebook]時，Haley看到另一個[!DNL Marketo Measure]貼文。 當她按一下此文章並重導至Adobe網站時，這會造成與[!DNL LinkedIn]相關的第一個網頁工作階段結束，且與[!DNL Facebook]相關的新工作階段開始。
