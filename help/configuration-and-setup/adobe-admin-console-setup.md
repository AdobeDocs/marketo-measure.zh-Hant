...
![存取Adobe Admin Console時，您會看到Marketo Measure](assets/adobe-setup-1.png)
...
![按一下Marketo Measure產品卡片會顯示您所有的](assets/adobe-setup-2.png)
...
![將使用者新增至產品設定檔後，他們就能完成](assets/adobe-setup-3.png)
