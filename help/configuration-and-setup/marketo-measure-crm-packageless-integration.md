...
[!DNL Salesforce]客戶按一下[這裡](/help/configuration-and-setup/install-set-up.md)。

[!DNL Microsoft Dynamics]客戶按一下[這裡](/help/microsoft-dynamics-crm-installation-guide.md)。
