---
description: Marketo Measure使用者的錯誤通知指引
title: 錯誤通知
...
若要在[!DNL Marketo Measure]中檢視完整的通知訊息，請按一下[通知]索引標籤底部的[檢視全部] **。**

![若要在Marketo Measure中檢視完整通知訊息，請按一下[檢視]](assets/adobe-setup-1.png)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>如需調整API信用配置的協助，請參閱下列CRM檔案：</p>
          <ul>
            <li><a href="https://learn.microsoft.com/en-us/dynamics365/fin-ops-core/dev-itpro/data-entities/service-protection-monitoring">動態</a>
            </li>
    ...
    <tr>
      ...
      <td>Crm匯出期間發生錯誤： CANNOT_EXECUTE_FLOW_TRIGGER ：實體型別「Contact」請為您的Salesforce管理員提供這些詳細資料。
超出限制
您或您的組織已超過此功能的最大限制。 錯誤ID：123456</td>
      <td>無法儲存記錄，因為它不符合Salesforce組織中設定的觸發程式流程規則。</td>
      <td>檢閱通知訊息的完整詳細資料，並在Salesforce組織中檢閱流程觸發器。
關於流程觸發程式<a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated">的Salesforce檔案可在此處找到</a>。
      </td>
    </tr>
    <tr>
      <td>CANNOT_INSERT_UPDATE_ACTIVATE_ENTITY</td>
      <td>Crm匯出期間發生錯誤： CANNOT_INSERT_UPDATE_ACTIVATE_ENTITY ：實體型別「Lead」： CRM錯誤碼： CANNOT_INSERT_UPDATE_ACTIVATE_ENTITY， CRM錯誤訊息： System.LimitException：已超過Apex CPU時間限制，記錄ID： 0123456
      <p>
      ...
      <td>檢閱導致插入/更新失敗的觸發程式碼。 如需有關觸發器的詳細資訊，請參閱下列Salesforce檔案：
        ...
        <p>
        為<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">Marketo Measure使用者</a>提供所有必要的許可權。
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>從<a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">自訂驗證規則</a>中排除Marketo Measure專用使用者。
          </li>
        </ul>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>請參閱下列<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">Experience League文章</a>，瞭解Marketo Measure所需許可權的指引。</td>
    </tr>
    <tr>
      <td>INVALID_ADOBE_ANALYTICS_CONFIGURATION</td>
      <td>Adobe Analytics匯出期間發生錯誤： INVALID_ADOBE_ANALYTICS_CONFIGURATION ：錯誤：不允許上傳。 上傳前先確認資料來源結構描述。 資料來源Id：1234</td>
      <td>Adobe Analytics整合的設定不正確。</td>
      <td>請參閱下列說明文章，以確保設定正確無誤：
        <ul>
          <li>
            <a href="/help/adobe-analytics.md">Marketo Measure與Adobe Analytics的整合</a>
          </li>
          <li>
    ...
    <tr>
      ...
      <td>我們要求所有首碼為「bizible2__」的欄位具有讀取和寫入許可權。 您可以在此文章</a>中找到這些欄位的完整清單<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">。</td>
    </tr>
    <tr>
      ...
      <td>請參閱下列Experience League檔案，以取得在您的CRM<br/>中啟用此許可權的相關協助
          <a href="/help/marketo-measure-salesforce-reporting/enabling-the-permission-to-edit-converted-leads.md">啟用許可權以編輯轉換的潛在客戶</a></td>
    </tr>
    <tr>
    ...
    SystemModstamp，IsDeleted，WhoId，bizible2__Bizible_Touchpoint_Date__c</td>
      ...
      <td>請參閱下列說明文章，以取得Marketo Measure所需許可權的指引：
        <ul>
          <li><a href="/help/marketo-measure-dynamics-schema.md">動態</a>
          </li>
    ...
    <tr>
      ...
      <td>Salesforce組織有幾個特有原因會導致此錯誤。 以下是幾個可解決此問題的常見疑難排解步驟：
        <ul>
          <li>檢閱每個<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">物件和欄位</a>所需的所有許可權。</li>
          <li>從<a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">自訂驗證規則</a>中排除Marketo Measure專用使用者。</li>
          <li>授予Marketo Measure "<a href="https://developer.salesforce.com/docs/atlas.en-us.securityImplGuide.meta/securityImplGuide/users_profiles_view_all_mod_all.htm">修改全部</a>"許可權。</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <p>
      如需「檢視全部資料」許可權<a href="https://developer.salesforce.com/docs/atlas.en-us.securityImplGuide.meta/securityImplGuide/users_profiles_view_all_mod_all.htm">的詳細資訊，請參閱此處</a>。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>停用Salesforce組織中的限制選取清單設定。
          <p>
          從<a href="https://trailhead.salesforce.com/content/learn/modules/validation-rules/bypass-your-validation-rules">自訂驗證規則</a>中排除Marketo Measure專用使用者。
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>將您的套件升級至最新版本：
        <ul>
          <li><a href="/help/configuration-and-setup/best-practices-for-marketo-measure-crm-package.md">最佳實務</a>
          </li>
          <li><a href="/help/microsoft-dynamics-crm-installation-guide.md">動態</a>
          </li>
