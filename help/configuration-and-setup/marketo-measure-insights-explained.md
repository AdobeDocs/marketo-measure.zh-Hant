...
瞭解[!DNL Marketo Measure]中的[!DNL Salesforce]深入分析檢視，包括不同的圖示代表什麼以及如何使用功能。 此功能非常有助於檢視潛在客戶、聯絡人或帳戶的前20個工作階段。
...
![首先，您會在深入分析的中間看到數字](assets/marketo-app-1.png)
