---
description: Marketo Measure使用者的歸因對應方法指引
title: 歸因對應方法
...
![Marketo Measure提供立即可用的帳戶ID對應。 此](assets/adobe-setup-1.png)
...
![雖然大多數使用者端都使用帳戶ID對應，但Marketo Measure可以尋找](assets/adobe-setup-2.png)
...
![除了僅檢視商機的聯絡人角色之外， Marketo](assets/adobe-setup-3.png)
