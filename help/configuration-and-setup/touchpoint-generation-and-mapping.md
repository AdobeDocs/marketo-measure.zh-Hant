---
description: Marketo Measure使用者的接觸點產生與對應指引
title: 接觸點產生與對應
...
>[!MORELIKETHIS]
>
>* [將線上接觸點對應至 [!DNL Marketo Measure] 管道/子管道](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
>* [從SFDC同步CRM行銷活動](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
>* [正在從 [!DNL Marketo Measure]](/help/channel-tracking-and-setup/custom-campaign-sync.md)內同步CRM行銷活動
>* [將CRM行銷活動對應至 [!DNL Marketo Measure] 管道/子管道](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
>* [從銷售活動建立接觸點](/help/channel-tracking-and-setup/salesforce-activities-attribution.md)
>* [活動常見問題集以及將活動接觸點對應到管道/子管道](/help/channel-tracking-and-setup/activities-attribution-faq.md)
