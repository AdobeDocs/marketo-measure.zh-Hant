---
description: 概述Marketo Measure如何與Salesforce交換資料，包括匯出許可權和批次設定
...
![如果您未安裝Marketo Measure Salesforce套件，](assets/bizible-full-1.png)
...
![依預設，Marketo Measure會為每個API點數匯出200筆記錄，每個](assets/bizible-taxonomy-1.png)
