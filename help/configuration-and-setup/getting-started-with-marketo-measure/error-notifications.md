...
關於流程觸發程式<a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated">的Salesforce檔案可在此處找到</a>。
    ...
    <tr>
      ...
      <td>檢閱導致插入/更新失敗的觸發程式碼。 如需有關觸發器的詳細資訊，請參閱下列Salesforce檔案：
        ...
        <p>
        為<a href="/help/configuration-and-setup/marketo-measure-and-salesforce/how-marketo-measure-and-salesforce-interact.md">Marketo Measure使用者</a>提供所有必要的許可權。
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>請參閱下列<a href="/help/configuration-and-setup/marketo-measure-and-salesforce/how-marketo-measure-and-salesforce-interact.md">Experience League文章</a>，瞭解Marketo Measure所需許可權的指引。</td>
    </tr>
    <tr>
      ...
      <td>請參閱下列說明文章，以確保設定正確無誤：
        <ul>
          <li>
            <a href="/help/marketo-measure-and-adobe/adobe-analytics.md">Marketo Measure與Adobe Analytics的整合</a>
          </li>
          <li>
    ...
    SystemModstamp，IsDeleted，WhoId，bizible2__Bizible_Touchpoint_Date__c</td>
      ...
      <td>請參閱下列說明文章，以取得Marketo Measure所需許可權的指引：
        <ul>
          <li><a href="/help/marketo-measure-and-dynamics/marketo-measure-dynamics-schema.md">動態</a>
          </li>
    ...
    <tr>
      ...
      <td>Salesforce組織有幾個特有原因會導致此錯誤。 以下是幾個可解決此問題的常見疑難排解步驟：
        <ul>
          <li>檢閱每個<a href="/help/configuration-and-setup/marketo-measure-and-salesforce/how-marketo-measure-and-salesforce-interact.md">物件和欄位</a>所需的所有許可權。</li>
    ...
    <tr>
      ...
      <td>將您的套件升級至最新版本：
        <ul>
          ...
          <li><a href="/help/marketo-measure-and-dynamics/microsoft-dynamics-crm-installation-guide.md">動態</a>
          </li>
