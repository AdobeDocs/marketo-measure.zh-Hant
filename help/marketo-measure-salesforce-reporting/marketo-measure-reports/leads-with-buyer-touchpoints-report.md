...
1. 針對物件關係，選取&#x200B;**[!DNL Marketo Measure]人員**&#x200B;物件作為次要物件。 選取A到B的關係，因為「每個&#39;A&#39;記錄必須至少有一個相關的&#39;B&#39;記錄」。 從那裡，您將會建立「Buyer Touchpoint」物件的關係，並在B和C物件之間選取相同的關係。
   ...
   ![物件關聯性選擇，包括Marketo Measure人員和購買者接觸點](assets/4.jpg)
