...
在建置[!DNL Marketo Measure]報告之前，最重要的是確認您的[!DNL Marketo Measure]帳戶設定已檢閱和設定，以確保報告中的資料準確並反映您業務的特性。 除此之外，報告專案在遵循結構化流程時運作效果最佳。 來自[Perkuto](https://perkuto.com/){target="_blank"}的[!DNL Marketo Measure]權力使用者、宣傳者和合作夥伴Justin Norris已對[如何在 [!DNL Marketo Measure]](https://perkuto.com/blog/turning-attribution-data-into-actionable-insights/){target="_blank"}中處理報告進行專業總結：

**建立目標**：「第一個要問的問題是『我們為什麼要測量？』 [Forrester Research](https://go.forrester.com/)的Lori Wizdo在[Marketo網路研討會](https://www.marketo.com/webinars/beyond-revenue-performance-real-kpis-of-b2b-marketing/){target="_blank"}中精闢總結。 根據她的說法，「我們衡量以證明或驗證決策或行銷的價值，或是獲得更好的結果（流程改進）。」 我們要加上的是，良好測量的深入解析也能為行銷計畫流程提供輸入和指引。
...
>[!TIP]
>
>對於任何「具有[!DNL Marketo Measure]個人的銷售機會」報告型別，從自訂標題為&#39;**[!DNL Marketo Measure]101的預建報告開始 |銷售機會/聯絡人（依頻道**）。 此報告現成可用，是絕佳的[!DNL Marketo Measure]人型沙箱。 這是預先建立的，可快速自訂，以滿足更具體的報告需求。
