...
當您熟悉&quot;_[!DNL Marketo Measure]101..._&quot;報告時，您可能想要從自訂報告型別重新建立它們，以滿足更多自訂報告需求。 建立[[!DNL Marketo Measure] 自訂報表型別](/help/marketo-measure-salesforce-reporting/new-report-types/creating-report-types.md)可讓您提取您可能常用於其他CRM報表的自訂欄位。 這將協助您將[!DNL Marketo Measure]報告提升到新的境界！
