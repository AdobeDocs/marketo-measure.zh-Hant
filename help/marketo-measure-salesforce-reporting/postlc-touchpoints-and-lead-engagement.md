---
description: 瞭解如何為潛在客戶及聯絡人建立、更新和限制PostLC接觸點
...
![Marketo Measure潛在客戶建立(PostLC)接觸點可供使用](assets/additional-functionality-1.png)的客戶使用
...
![PostLC接觸點是動態的。 作為潛在客戶或連絡人繼續提交](assets/additional-functionality-2.png)
...
1. 在[!DNL Marketo Measure]experience.adobe.com/marketo-measure[登入您的](https://experience.adobe.com/marketo-measure){target="_blank"}帳戶並移至[!UICONTROL Settings]。

1. 在CRM底下，選取&#x200B;**[!UICONTROL Leads]**。

1. 輸入您要推送至銷售機會的postLC接觸點數目，然後按一下&#x200B;**[!UICONTROL Save]**。

   ![1. 輸入您要推送到](assets/additional-functionality-3.png)的postLC接觸點數目
...
1. 輸入您要推送至連絡人的postLC接觸點數目，然後按一下&#x200B;**[!UICONTROL Save]**。
   ...
   ![1. 輸入您要推送到](assets/additional-functionality-4.png)的postLC接觸點數目
