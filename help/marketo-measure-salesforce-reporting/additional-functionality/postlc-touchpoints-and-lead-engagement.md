...
![在Salesforce中顯示PostLC接觸點的潛在客戶記錄](assets/1.png)
...
![PostLC接觸點清單上限為最近提交的四個](assets/2.png)
...
1. 輸入您要推送至銷售機會的postLC接觸點數目，然後按一下&#x200B;**[!UICONTROL Save]**。
   ...
   ![要設定PostLC接觸點限制的潛在客戶設定頁面](assets/3.png)
...
1. 輸入您要推送至連絡人的postLC接觸點數目，然後按一下&#x200B;**[!UICONTROL Save]**。
   ...
   ![連絡人設定頁面以設定PostLC接觸點限制](assets/4.png)
