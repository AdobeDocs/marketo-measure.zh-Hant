...
1. 前往「**[!UICONTROL Setup]** > **[!UICONTROL Build]** > **[!UICONTROL Report Types]** > **[!UICONTROL New Custom Report Types]**」。
   ...
   ![1. 移至設定建置報告型別New](assets/new-types-1.png)
...
1. 定義自訂報表型別。
   ...
   * [!UICONTROL Deployment] > [!UICONTROL Deployment Status]：已部署
   ...
   ![部署部署狀態：已部署](assets/new-types-10.jpg)
...
1. 定義自訂報表型別。
   ...
   * [!UICONTROL Deployment] > [!UICONTROL Deployment Status]：已部署
   ...
   ![部署部署狀態：已部署](assets/new-types-13.jpg)
...
1. 定義自訂報表型別。
   ...
   * [!UICONTROL Deployment] > [!UICONTROL Deployment Status]：已部署
   ...
   ![部署部署狀態：已部署](assets/new-types-14.jpg)
