...
深入瞭解[Marketo Measure Ultimate](/help/marketo-measure-ultimate/overview.md){target="_blank"}。
...
![顯示類別和欄位群組關係的結構描述結構圖](assets/marketo-measure-ultimate-implementation-guide-1.png)

[資料集總覽](https://experienceleague.adobe.com/docs/experience-platform/catalog/datasets/overview.html?lang=zh-Hant){target="_blank"}：所有成功內嵌至AEP的資料都會以資料集的形式保留在資料湖中。 資料集是資料集合的儲存和管理結構，通常是包含方案 (欄) 和欄位 (列) 的表格。 
...
![具有[新增資料]和[使用範本]選項的[來源]頁面](assets/marketo-measure-ultimate-implementation-guide-2.png)

* 選取一個帳戶和所有B2B範本，以建立十個標準B2B結構描述。

![範本選取範圍顯示帳戶設定的B2B結構描述範本](assets/marketo-measure-ultimate-implementation-guide-3.png)
...
資料管理中的![查詢索引標籤顯示查詢介面](assets/marketo-measure-ultimate-implementation-guide-4.png)
...
![階段對應介面顯示來自多個來源的階段組態](assets/marketo-measure-ultimate-implementation-guide-5.png)
