...
由於目前的Snowflake Direct Share限制，[!DNL Marketo Measure]將只能以Azure East US 2中的帳戶設定Snowflake Direct Share。 若需要讓您的資料在其他Snowflake地區可用，建議您在Azure美國東部2的Snowflake帳戶中製作資料副本，並使用[Snowflake資料庫復寫](https://docs.snowflake.com/en/user-guide/database-replication-intro.html){target="_blank"}功能，在您選擇的Snowflake地區/帳戶中複製您的資料。
