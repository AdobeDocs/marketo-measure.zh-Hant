...
在深入瞭解每個平台的具體資訊之前，我們將先探討如何將這些帳戶中的任何一個連結至[!DNL Marketo Measure]。 請先登入[!DNL Marketo Measure]應用程式並導覽至畫面左上方的&#x200B;**[!UICONTROL Settings]**&#x200B;標籤下的&#x200B;**[!UICONTROL My Account]**&#x200B;選項。 接著，在左側的&#x200B;**[!UICONTROL Connections]**&#x200B;區段下選取&#x200B;**[!UICONTROL Integrations]**。
...
1. 在[!DNL Marketo Measure]experience.adobe.com/marketo-measure[登入您的](https://experience.adobe.com/marketo-measure){target="_blank"}帳戶。
