...
![LinkedIn廣告格式型別，顯示單一影像廣告、視訊廣告和轉盤選項，支援Lead Gen Forms](assets/one.png)
...
![在自動標籤程式前顯示四個創意專案及其關聯共用的圖表](assets/two.png)
...
![圖表顯示具有自動標籤和封存程式後所建立唯一共用的新創意](assets/three.png)
...
![行銷管道規則組態顯示LinkedIn付費管道定義與反向連結欄](assets/four.png)
...
![LinkedIn廣告，顯示已標籤之說明中的目的地URL和縮短的URL](assets/five.png)
...
![LinkedIn行銷活動管理員，顯示在URL](assets/six.png)中顯示共用ID的新標籤中開啟的廣告
