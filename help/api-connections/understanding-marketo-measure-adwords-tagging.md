...
* 如果在追蹤範本中找到協力廠商重新導向，例如Kenshoo或Marin，[!DNL Marketo Measure]將不會採取任何動作。 您必須[新增 [!DNL Marketo Measure] 引數至您帳戶](/help/api-connections/how-bid-management-tools-affect-marketo-measure.md){target="_blank"}中的協力廠商工具。
