...
* [什麼是行銷歸因？](/help/marketing-attribution.md)
* [[!DNL Marketo Measure]歸因模型](/help/attribution-models.md)

**設定**

* [行銷管道設定，最佳實務](/help/channel-tracking-and-setup/marketing-channels-and-subchannels.md)
* [線上頻道設定](/help/channel-tracking-and-setup/online-custom-channel-setup.md)
* [離線管道設定](/help/channel-tracking-and-setup/offline-custom-channel-setup.md)
* [什麼是UTM引數？](/help/channel-tracking-and-setup/utm-parameters.md)
* [UTM最佳作法](/help/channel-tracking-and-setup/best-practices-for-setting-up-utm-parameters.md)
* [將SFDC行銷活動與購買者接觸點同步](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
* [上傳行銷支出](/help/marketing-channel-costs.md)
* [重新連線Ad帳戶](/help/api-connections/reauthorizing-connected-accounts.md)
* [正在新增 [!DNL Marketo Measure] JavaScript](/help/marketo-measure-tracking/adding-marketo-measure-script.md)
   * [排除Forms](/help/marketo-measure-tracking/excluding-marketo-measure-from-specific-forms.md)

**報告**

* [使用 [!DNL Marketo Measure]](/help/marketo-measure-salesforce-reporting/creating-report-types.md)建立自訂報告型別（如果您必須報告自訂銷售機會/連絡人/商機欄位）
* [&#x200B; [!DNL Marketo Measure] 欄位的字彙表](/help/glossary.md)

**疑難排解**

* [正在授予 [!DNL Marketo Measure] 對SFDC的支援存取權](/help/salesforce-access.md)
