...
+ [!DNL Marketo Measure]追蹤 {#marketo-measure-tracking}
   + 設定追蹤 {#setting-up-tracking}
      ...
      + [正在新增 [!DNL Marketo Measure] 指令碼](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script.md)
      + [透過Google Tag Manager新增 [!DNL Marketo Measure] 指令碼](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-via-google-tag-manager.md)
      + [JavaScript所收集的資料](marketo-measure-tracking/setting-up-tracking/data-collected-by-javascript.md)
      + 正在新增[!DNL Marketo Measure]指令碼至不同的表單提供者 {#adding-marketo-measure-script-to-different-form-providers}
         + [正在將 [!DNL Marketo Measure] JavaScript新增至Pardot](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-javascript-to-pardot.md)
         + [正在新增 [!DNL Marketo Measure] Script至Lightbox Forms](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-lightbox-forms.md)
         + [正在新增 [!DNL Marketo Measure] 指令碼至Sitecore頁面](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-sitecore-pages.md)
         + [正在新增 [!DNL Marketo Measure] 指令碼至Uberflip Forms](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-uberflip-forms.md)
         + [正在新增 [!DNL Marketo Measure] 至實際執行Forms](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-act-on-forms.md)
         + [正在新增 [!DNL Marketo Measure] 至Hubspot](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-hubspot.md)
         + [正在新增 [!DNL Marketo Measure] 至Marketo登陸頁面](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-marketo-landing-pages.md)
...
+ 組態與設定 {#configuration-and-setup}
   + 開始使用[!DNL Marketo Measure] {#getting-started-with-marketo-measure}
      ...
      + [跨BT和 [!DNL BATs]的接觸點位置和產生方式說明](configuration-and-setup/getting-started-with-marketo-measure/explanation-of-touchpoint-positions-and-generation-across-bts-and-bats.md)
...
+ [!DNL Marketo Measure]與Adobe {#marketo-measure-and-adobe}
   + [[!DNL Marketo Measure]與Adobe Analytics的整合](marketo-measure-and-adobe/marketo-measure-integrations-with-adobe-analytics.md)
   + [[!DNL Marketo Measure]與Adobe Launch的整合](marketo-measure-and-adobe/marketo-measure-integrations-with-adobe-launch.md)
   + [網域管理](marketo-measure-and-adobe/domain-management.md)
   + [Adobe Experience Cloud 介面概觀](marketo-measure-and-adobe/experience-cloud-interface-overview.md)
...
+ [!DNL Marketo Measure]與Marketo {#marketo-measure-and-marketo}
   + [!DNL Marketo Measure]與Marketo的整合 {#marketo-measure-integrations-with-marketo}
      ...
      + [Marketo Engage程式整合](marketo-measure-and-marketo/marketo-measure-integrations-with-marketo/marketo-engage-programs-integration.md)
...
+ BI報表範本 {#bi-report-templates}
   + [[!DNL Marketo Measure]報告範本 — Power BI](bi-report-templates/marketo-measure-report-template-power-bi.md)
   + [[!DNL Marketo Measure]報告範本 — Tableau](bi-report-templates/marketo-measure-report-template-tableau.md)
+ 安全性與合規性 {#security-and-compliance}
   + 合規性相關資源 {#compliance-related-resources}
      ...
      + [在 [!DNL Marketo Measure] Js中確保GDPR的同意](security-and-compliance/compliance-related-resources/ensuring-consent-for-gdpr-in-marketo-measure-js.md)
...
+ 其他 {#miscellaneous}
   + 其他相關資源 {#other-related-resources}
      ...
      + [Google Analytics轉換與Buyer Touchpoint之間的差異](miscellaneous/other-related-resources/difference-between-a-google-analytics-conversion-and-a-buyer-touchpoint.md)
