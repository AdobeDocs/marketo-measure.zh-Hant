...
+ 頻道追蹤與設定{#channel-tracking-and-setup}
...
+ API連線{#api-connections}
   + 使用[!DNL Marketo Measure]的API連線{#utilizing-marketo-measures-api-connections}
...
+ [!DNL Marketo Measure]和Adobe{#marketo-measure-and-adobe}
   ...
   + [[!DNL Marketo Measure]與Adobe啟動整合](marketo-measure-and-adobe/marketo-measure-integrations-with-adobe-launch.md)
...
+ [!DNL Marketo Measure] Salesforce報告{#marketo-measure-salesforce-reporting}
   ...
   + [!DNL Marketo Measure]報告{#marketo-measure-reports}
...
+ 安全性與合規性{#security-and-compliance}
   + 規範遵循相關資源{#compliance-related-resources}
