---
description: 顯示如何設定bizible.js，以便在設定Cookie或傳送資料前等待GDPR的使用者同意
...
>[!NOTE]
>
>在此情況下，[!DNL bizible.js]會將點按事件附加至ID為「ConsentButtonId」的HTML元素。

按一下此HTML元素時，[!DNL bizible.js]會建立Cookie以記住已收到使用者的同意，並開始照常收集分析資料。
...
*window[&#39;Bizible&#39;] = window[&#39;Bizible&#39;] || { _queue： []，推送：函式(o， p) {此。_queue.push({ type： o， data： p })； } }；*
