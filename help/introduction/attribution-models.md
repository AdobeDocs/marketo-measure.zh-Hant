---
description: Marketo Measure歸因模型
...
![客戶歷程時間表顯示四個里程碑接觸點：首次接觸、建立銷售機會、建立商機及成功關閉](assets/overview-resources-8.png)
...
![首次接觸模型圖表顯示Adwords管道](assets/overview-resources-9.png)的100%歸因評分
...
![潛在客戶建立模型圖表顯示LinkedIn管道](assets/overview-resources-10.png)的100%歸因評分
...
![U形模型圖表顯示50%點數給Adwords，50%點數給LinkedIn](assets/overview-resources-11.png)
...
![W形模型圖表顯示30%點數分別歸於FT、LC和OC接觸點，10%歸於中介接觸點](assets/overview-resources-12.png)
...
![完整路徑模型圖表顯示各有22.5%的點數歸給FT、LC、OC和CW接觸點，10%則歸給中介接觸點](assets/overview-resources-13.png)
