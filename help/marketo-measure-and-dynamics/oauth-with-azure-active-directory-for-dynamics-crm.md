...
1. 選擇Azure AD租使用者，方法是按一下頁面右上角的帳戶，然後按一下[切換目錄]導覽，然後選取適當的租使用者。 如果您的帳戶下只有一個Azure AD租使用者，或您已選取適當的Azure AD租使用者，請略過此步驟。
   ...
   ![Azure入口網站租使用者選取下拉式功能表](assets/setup-2.png)

1. 在搜尋列中搜尋「[!DNL Azure Active Directory]」，然後按一下名稱以開啟。

   ![顯示Azure Active Directory的Azure入口網站搜尋結果](assets/setup-3.png)

1. 按一下左側功能表中的&#x200B;**[!UICONTROL App Registrations]**。

   ![具有應用程式註冊的Azure Active Directory導覽功能表](assets/setup-4.png)

1. 按一下頂端的&#x200B;**[!UICONTROL New Registration]**。

   ![具有新註冊按鈕的應用程式註冊頁面](assets/setup-5.png)
...
1. 按一下左側功能表中的&#x200B;**[!UICONTROL Authentication]**。
   ...
   ![已反白顯示驗證選項的應用程式功能表](assets/setup-9.png)
...
1. 第一次設定Dynamics連線時，請依照[本文章](/help/marketo-measure-and-dynamics/microsoft-dynamics-crm-installation-guide.md)中「CRM為資料提供者」章節的步驟1-5操作。
...
顯示使用者端密碼值的![憑證和密碼頁面](assets/creating-2e.png)
...
1. 按一下金鑰時，會出現快顯視窗，提示您輸入使用者端ID、使用者端密碼和應用程式ID URI，類似於註冊流程。
   ...
   ![使用OAuth認證欄位重新驗證對話方塊](assets/re-authenticating-3.png)
