...
![成本、歸因收入和ROI的ROI儀表板KPI圖磚](assets/roi-dashboard-1.png)
...
![依據管道棧疊長條圖的成本和收入](assets/roi-dashboard-2.png)
...
![已實現與簡單ROI趨勢線圖](assets/roi-dashboard-3.png)
...
![具鑽研控制項的時間棧疊長條圖成本](assets/roi-dashboard-4.png)
...
![依據管道長條圖的行銷支出](assets/roi-dashboard-5.png)
