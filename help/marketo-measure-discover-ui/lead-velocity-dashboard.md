...
![銷售階段長條圖的銷售機會或聯絡速度](assets/lead-velocity-dashboard-1.png)
...
![潛在客戶速度趨勢與時間線圖](assets/lead-velocity-dashboard-2.png)
...
![依據管道比較圖表的潛在客戶速度](assets/lead-velocity-dashboard-3.png)
