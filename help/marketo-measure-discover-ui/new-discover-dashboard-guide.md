  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul>
          ...
          <li>
            <strong>網站Forms與網站Forms在一段時間內的趨勢</strong>：網站流量儀表板</li>
          <li>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
            <strong>關鍵字和Creative ROI摘要：</strong>已棄用（請參閱下文）</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>
            <strong>同類群組Funnel：</strong>同類群組歷程儀表板</li>
          <li>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <p>
          <strong>關鍵字和Creative ROI摘要</strong>
        </p>
      </td>
      <td>
...
* **日期型別、量度、Dimension、分組依據**：這些設定現在已為每個儀表板預先定義，以最佳化insight傳遞。 如需詳細資訊，請參閱工具提示和隨附檔案。
* **促銷活動來源**
* **帳戶ID和名稱**：正在檢閱。

## 新增功能和改進專案 {#new-additions-and-improvements}

您可以在[探索儀表板基本知識](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}文章中找到新功能。
