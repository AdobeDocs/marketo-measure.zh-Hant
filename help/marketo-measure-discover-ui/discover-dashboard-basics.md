...
![視覺化工具提示上的篩選器列出套用的篩選器](assets/discover-dashboard-basics-3b.png)
...
![探索儀表板，顯示視覺效果](assets/discover-dashboard-basics-4.png)上的鑽研控制項

* 按一下以灰色背景反白的向下單一箭頭來啟動向下鑽研。 若要還原，請使用向上鑽研圖示。

![單一層級深入分析已在圖表上啟動](assets/discover-dashboard-basics-5.png)

若要一次向下鑽研一個欄位，請開啟向下鑽研圖示並選取視覺元素，例如長條圖。

![在圖表上一次向下鑽研一個欄位](assets/discover-dashboard-basics-6.gif)

使用雙箭頭向下鑽研圖示來前進到下一個階層層級。

![使用雙箭頭向下鑽研以移至下一個階層](assets/discover-dashboard-basics-7.gif)

使用類似分叉圖示，在目前檢視中新增額外的階層層級。

![使用分叉圖示新增額外的階層層級](assets/discover-dashboard-basics-8.gif)

### 鑽研 {#drill-through}

若要探索視覺效果背後的資料，請以滑鼠右鍵按一下視覺元素，然後選取「鑽研」選項。

![以滑鼠右鍵鑽研視覺效果](assets/discover-dashboard-basics-9.gif)的詳細資料

### 匯出資料 {#export-data}

若要從視覺效果匯出基礎資料，請將游標停留在視覺效果的右上角。 按一下「更多選項」按鈕，選擇「匯出資料」，選取您偏好的格式，然後按一下「匯出」。
![從視覺化儀表板](assets/discover-dashboard-basics-10.gif)匯出資料功能表

### 焦點模式 {#focus-mode}

若要放大特定視覺效果或圖磚，請將游標移至右上角並選取「焦點」按鈕。

![將儀表板視覺切換至焦點模式](assets/discover-dashboard-basics-11.gif)

### 交叉篩選 {#cross-filtering}

在一個視覺效果中選取值或軸標籤，即可交叉篩選報表頁面上的其他視覺效果，確保這些視覺效果只會顯示相關的已篩選資料。

![選取圖表上的值，以交叉篩選視覺效果](assets/discover-dashboard-basics-12.gif)

### 工具提示 {#tooltips}

工具提示提供所顯示資料的補充詳細資料。 將游標暫留在視覺元素上，內容工具提示隨即出現，提供與該特定資料點相關的深入分析或說明。

![在儀表板視覺化顯示內容資料的暫留工具提示](assets/discover-dashboard-basics-13.gif)
