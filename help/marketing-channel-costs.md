...
[按一下這裡直接導覽至指示。](/help/marketing-channel-costs.md)
...
[按一下這裡直接導覽至常見問答集。](/help/marketing-channel-costs.md)
...
一旦行銷管道和規則設定或更新後，相關成本便可上傳。 請依照下列步驟執行此操作：
...
![移至[我的帳戶]功能表，按一下[設定]，然後](assets/spend-management-4.png)

**步驟2：下載目前的成本CSV**

導覽至畫面右側，然後按一下&#x200B;**[!UICONTROL Download Current Costs].** 此選項可讓您下載CSV格式的試算表。

![瀏覽至畫面右側，然後按一下[下載目前版本]](assets/spend-management-1.png)
...
![例如，將Facebook表示為子管道，將social表示為](assets/spend-management-2.png)
