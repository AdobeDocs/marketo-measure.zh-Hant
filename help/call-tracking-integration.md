...
CallTrackingMetrics必須在其終端執行一些開發工作，才能正常運作。 透過CallTrackingMetrics放置於您網站上的JavaScript，可以從[!DNL Marketo Measure] Cookie抓取`_biz_uid`。 然後，CallTrackingMetrics會儲存此「BizibleId」。
