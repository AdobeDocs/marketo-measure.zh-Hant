...
![成交交易(CW)](assets/overview-resources-8.png)
...
![說Kate第一次透過Adwords廣告造訪www.adobe.com](assets/overview-resources-9.png)
...
![從Kate第一次透過](assets/overview-resources-10.png)造訪www.adobe.com之後繼續上一個範例
...
![Kate透過Adwords廣告第一次造訪www.adobe.com將獲得50%](assets/overview-resources-11.png)
...
![Hillary收到一封電子郵件，內含訂價頁面的連結及](assets/overview-resources-12.png)
...
![機會建立後，Kate、Austin和Hillary決定推介Marketo](assets/overview-resources-13.png)
