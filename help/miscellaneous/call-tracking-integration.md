...
![根據不同行銷管道和行銷活動顯示唯一電話號碼的圖表](assets/1.png)
...
![前後流程圖比較未使用與具有CallTrackingMetrics整合的通話追蹤](assets/2.png)
...
![Salesforce任務記錄範例顯示BizibleId欄位已填入值](assets/3.png)
...
![接觸點記錄顯示來自合併的網頁工作階段和電話通話資料的[型別]](assets/4.png)
...
![顯示接觸點型別的報告，包括電話通話，以追蹤頻道產生的通話收入](assets/5.png)
...
![圖表顯示廣告點按與電話通話之間的30分鐘網路工作階段逾時期間](assets/6.png)
