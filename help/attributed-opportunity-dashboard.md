...
![上個月依管道劃分的歸因機會金額明細為何？](assets/attributed-dashboard-3.png)
...
![按一下每個管道旁的+圖示以顯示劃分依據](assets/attributed-dashboard-1.png)
...
![按一下分支以深入探究後續階層層。](assets/attributed-dashboard-2.png)
