...
1. 若要執行測試，請按一下如下所示的&#x200B;**[!UICONTROL TEST]**&#x200B;按鈕。
   ...
   程式規則介面中的![測試按鈕](assets/seven.png)

1. 強制回應視窗會出現，您可在其中輸入來自Marketo的方案ID。

   ![包含程式識別碼輸入欄位的測試模型對話方塊](assets/eight.png)
   ...
   ![測試結果顯示符合成員計數為](assets/nine.png)的方案

   您可以按一下「成員計數」，檢視符合方案資格的Marketo人員ID清單。

   ![測試結果中的合格Marketo人員ID清單](assets/ten.png)
...
1. 首先，選取應對應至值的管道，然後選擇性選取子管道。 完成後，請按一下底部的&#x200B;**[!UICONTROL Save]**。
   ...
   ![顯示Marketo程式頻道對應選項的離線頻道設定](assets/eleven.png)
