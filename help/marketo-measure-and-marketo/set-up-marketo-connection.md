...
>[!PREREQUISITES]
>
>[為](https://experienceleague.adobe.com/docs/marketo/using/product-docs/administration/users-and-roles/create-an-api-only-user.html?lang=zh-Hant)/Marketo Engage連線建立僅API使用者角色[!DNL Marketo Measure]。
