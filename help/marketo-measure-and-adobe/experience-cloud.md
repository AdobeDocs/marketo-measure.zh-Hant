...
![包含Marketo Measure選取選項的Adobe Experience Cloud功能表](assets/unified-shell-overview-4.png)
...
![網域管理介面顯示網域組態選項](assets/unified-shell-overview-5.png)

**整合式說明中心**

搜尋支援文章、提交票證、提供意見回饋，所有這些都是從[!DNL Marketo Measure]應用程式中進行。

![整合式說明中心，提供搜尋與支援選項](assets/unified-shell-overview-6.png)

**應用程式切換器**

能夠存取多個Adobe產品的使用者可在兩者之間輕鬆切換。

![應用程式切換器顯示可用的Adobe產品](assets/unified-shell-overview-7.png)

**通知和公告**

直接在應用程式中檢視產品特定通知和一般 Adobe 產品公告，並進行互動。

![具有警示指示器的通知圖示](assets/unified-shell-overview-8.png)

![顯示產品公告和更新的通知面板](assets/unified-shell-overview-9.png)

**Adobe 設定**

若要變更您的語言或其他Adobe偏好設定，請按一下您的個人資料圖示。 您也可以按一下[!DNL Marketo Measure]我的設定&#x200B;**，進行**&#x200B;特定的變更。

![包含「Adobe設定」和「我的設定」選項的「設定檔」功能表](assets/unified-shell-overview-10.png)
...
![顯示Marketo Measure連線問題的錯誤頁面](assets/unified-shell-overview-11.png)
