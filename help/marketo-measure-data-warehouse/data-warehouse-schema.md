...
>[!IMPORTANT]
>
>含有_DELETED_DATE值的列將保留15天，然後從Snowflake中刪除。 Snowflake時區以UTC為單位。
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>此 [!DNL Marketo Measure] 根據年齡和階段估計聯繫人是否有助於機會關閉的算法</p>
      </td>
      <td>
        <p>.290034</p>
      </td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>此 [!DNL Marketo Measure] 根據年齡和階段估計Lead是否會轉換的演算法。</p>
      </td>
      <td>
        <p>.290034</p>
      </td>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>此 [!DNL Marketo Measure] 根據年齡和階段來估計機會是否會關閉的演算法。</p>
      </td>
      <td>
